...
Webflow.push(function () {
    window.addEventListener('load', function () {
       ...
       `;
        ...
        document.querySelectorAll('.guide-accordion-item.general,.highlights-container .highlights-time').forEach(function (item) {
    ...
    if (tabOrder.length > 0) {
        ...
        function reorderTabs(order) {
            ...
            setTimeout(function () {
                const firstTabButton = tabButtons.find(el => el.getAttribute('data-tab-name') === tabOrder[0]);
                if (firstTabButton) {
